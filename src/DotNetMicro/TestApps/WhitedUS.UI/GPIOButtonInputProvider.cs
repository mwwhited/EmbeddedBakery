...
namespace WhitedUS.UI
{
    ...
    public sealed class GPIOButtonInputProvider
    {
        ...
        public GPIOButtonInputProvider(PresentationSource source)
        {
            ...
            Cpu.Pin pinBack = Cpu.Pin.GPIO_NONE;
            Cpu.Pin pinMenu = Cpu.Pin.GPIO_NONE;
            Cpu.Pin pinEscape = Cpu.Pin.GPIO_NONE;
            Cpu.Pin pinHome = Cpu.Pin.GPIO_NONE;
            ...
            else
            {
                ...
                pinBack = hwProvider.GetButtonPins(Button.VK_BACK);
                pinMenu = hwProvider.GetButtonPins(Button.VK_MENU);
                pinEscape = hwProvider.GetButtonPins(Button.VK_ESCAPE);
                pinHome = hwProvider.GetButtonPins(Button.VK_HOME);
            }
                ...
                ArrayList buttons = new ArrayList()
            {
                ...
                if (pinBack != Cpu.Pin.GPIO_NONE) buttons.Add(new ButtonPad(this, Button.VK_BACK, pinBack));
                if (pinMenu != Cpu.Pin.GPIO_NONE) buttons.Add(new ButtonPad(this, Button.VK_MENU, pinMenu));
                if (pinEscape != Cpu.Pin.GPIO_NONE) buttons.Add(new ButtonPad(this, Button.VK_ESCAPE, pinEscape));
                if (pinHome != Cpu.Pin.GPIO_NONE) buttons.Add(new ButtonPad(this, Button.VK_HOME, pinHome));

                this.buttons = (ButtonPad[])buttons.ToArray(typeof(ButtonPad));
            }
            catch (Exception ex)
            {
