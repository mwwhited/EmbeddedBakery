    ...
    public sealed class GPIOButtonInputProvider
    {
        ...
        public GPIOButtonInputProvider(PresentationSource source)
        {
            ...
            ButtonPad[] buttons = new ButtonPad[]
            {
                ...
                new ButtonPad(this, Button.Left  , GHIElectronics.Hardware.EmbeddedMaster.Pins.E23x),
                new ButtonPad(this, Button.Right , GHIElectronics.Hardware.EmbeddedMaster.Pins.E1x),
                new ButtonPad(this, Button.Up    , GHIElectronics.Hardware.EmbeddedMaster.Pins.E4x),
                new ButtonPad(this, Button.Select, GHIElectronics.Hardware.EmbeddedMaster.Pins.E30x),
                new ButtonPad(this, Button.Down  , GHIElectronics.Hardware.EmbeddedMaster.Pins.E0x),
            };
