...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "HCounterWidth" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "VCounterWidth" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "XPixelSubDivision" -parent ${Page_0}
  ipgui::add_param $IPINST -name "YPixelSubDivision" -parent ${Page_0}
