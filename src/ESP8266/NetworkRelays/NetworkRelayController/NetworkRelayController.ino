// https://raw.githubusercontent.com/khoih-prog/EthernetWebServer/master/examples/FS_EthernetWebServer/FS_EthernetWebServer.ino

/*
Updated by: Matthew Whited 
  * 20230220: Ensure the board is NodeMCU 1.0 (ESP-12E)
*/
