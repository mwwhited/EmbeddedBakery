...
#define USI_UART_TCNTn TCNTn
#define USI_UART_TCCRn TCCRn
#define USI_UART_TOVn  TOVn
#define USI_UART_TOIEn TOIEn
...
void USI_UART_Initialise_Transmitter( void )                              
{
    cli();
    USI_UART_TCNTn  = 0x00;
    USI_UART_TCCRn  = (1<<PSRn)|(0<<CS02)|(0<<CS01)|(1<<CS00);         // Reset the prescaler and start TimerN.
