//Based on https://github.com/dariomas/DigitLed72xx/blob/044a09b9ac465df87db550d15526259da0811625/src/DigitLed72xx.h
...
public:
   ...
   // void printHex(long number, unsigned char nDevice = 0, byte startDigit = 0);
