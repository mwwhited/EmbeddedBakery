...
//
//From: https://docs.labs.mediatek.com/resource/linkit7697-arduino/en/tutorial/driving-7-segment-displays-with-max7219
...
const int data_latch_pin = 7;
// pin 1 of MAX7219 (DIN)
const int data_input_pin = 11;
