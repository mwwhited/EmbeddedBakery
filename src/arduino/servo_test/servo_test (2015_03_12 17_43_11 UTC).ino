...
void forward() {
  ...
  pwm.setPWM(LeftFrontKnee, 0, 500);
  pwm.setPWM(LeftFrontHip, 0, 300);
  
  pwm.setPWM(RightFrontKnee, 0, 240);
  pwm.setPWM(RightFrontHip, 0, 425);
  delay(100);
  
  pwm.setPWM(LeftBackKnee, 0, 500);
  pwm.setPWM(LeftBackHip, 0, 250);
  pwm.setPWM(LeftFrontKnee, 0, 580);
  
  pwm.setPWM(RightBackKnee, 0, 240);
  pwm.setPWM(RightBackHip, 0, 500);
  pwm.setPWM(RightFrontKnee, 0, 210);
  delay(100);
  ...
  pwm.setPWM(LeftBackHip, 0, 450);
  pwm.setPWM(LeftFrontHip, 0, 500);
  pwm.setPWM(RightBackHip, 0, 250);
  pwm.setPWM(RightFrontHip, 0, 325);
  delay(100);  
}
